...
#line 44
TMicro;
# 11 "/opt/tinyos-2.1.2/tos/lib/net/tymo/RoutingTableInfo.nc"
#line 8
typedef nx_struct rt_link {
  nx_addr_t target;
  nx_addr_t nexthop;
} __attribute__((packed)) rt_link_t;
...
# 8 "/home/brad/workspace/TestTymo/src/build/telosb/StorageVolumes.h"
...
typedef TMilli DymoEngineM__Timer__precision_tag;
enum /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0____nesc_unnamed4316 {
...
enum /*HplStm25pSpiC.SpiC*/Msp430Spi0C__0____nesc_unnamed4317 {
  Msp430Spi0C__0__CLIENT_ID = 1U
};
enum /*HplStm25pSpiC.SpiC.UsartC*/Msp430Usart0C__1____nesc_unnamed4318 {
...
error_t error);
# 7 "/opt/tinyos-2.1.2/tos/lib/net/tymo/dymo/DymoMonitor.nc"
static void TestM__DymoMonitor__msgSent(message_t *msg);

static void TestM__DymoMonitor__routeDiscovered(uint32_t delay, addr_t target);
#line 5
static void TestM__DymoMonitor__msgReceived(message_t *msg);
...
static void /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__sendFailed(message_t *msg, uint8_t why);
#line 3
static void /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__msgReceived(message_t *msg);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void DymoEngineM__Timer__fired(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
static int8_t TestM__CC2420Packet__getRssi(message_t *p_msg);
# 68 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
...
static am_addr_t TestM__MHPacket__destination(
#line 74
message_t * amsg);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 58 "/home/brad/workspace/TestTymo/src/TestM.nc"
enum TestM____nesc_unnamed4319 {
#line 58
  TestM__stop = 0U
};
#line 58
...
uint8_t TestM__dest = TestM__TARGET;
uint16_t TestM__rssi = 0;

static inline uint16_t TestM__getRssi(message_t *msg);
#line 49
...
static inline void TestM__DymoMonitor__msgReceived(message_t *msg);



static inline void TestM__DymoMonitor__msgSent(message_t *msg);



static inline void TestM__DymoMonitor__routeDiscovered(uint32_t delay, addr_t target);
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
...
#line 18
typedef enum OneWireMasterC____nesc_unnamed4343 {
...
enum /*BusyWaitMicroC.BusyWaitCounterC*/BusyWaitCounterC__0____nesc_unnamed4344 {
...
#line 89
typedef enum CC2420TransmitP____nesc_unnamed4345 {
...
enum CC2420TransmitP____nesc_unnamed4346 {
...
#line 89
#line 81
typedef enum CC2420ReceiveP____nesc_unnamed4348 {
...
enum /*CounterMilli32C.Transform*/TransformCounterC__1____nesc_unnamed4350 {
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC__1____nesc_unnamed4351 {
...
enum /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC__0____nesc_unnamed4352 {
#line 74
...
#line 59
typedef struct /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0____nesc_unnamed4355 {
...
enum UniqueSendP____nesc_unnamed4356 {
  UniqueSendP__S_IDLE, 
...
#line 56
struct UniqueReceiveP____nesc_unnamed4357 {
  uint16_t source;
  uint8_t dsn;
...
enum UniqueReceiveP____nesc_unnamed4358 {
...
# 49 "/opt/tinyos-2.1.2/tos/system/FcfsResourceQueueC.nc"
enum /*CC2420TinyosNetworkC.FcfsResourceQueueC*/FcfsResourceQueueC__0____nesc_unnamed4362 {
#line 49
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP__0____nesc_unnamed4365 {
  message_t * msg;
...
uint8_t arg_0x40f7c9f0);
#line 71
enum /*DymoTableC.Timers*/VirtualizeTimerC__1____nesc_unnamed4366 {
#line 71
...
#line 59
typedef struct /*DymoTableC.Timers*/VirtualizeTimerC__1____nesc_unnamed4368 {
...
enum /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0____nesc_unnamed4369 {
...
static inline void /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__msgReceived(message_t *msg);

static inline void /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__sendFailed(message_t *msg, uint8_t why);
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
...
# 7 "/opt/tinyos-2.1.2/tos/lib/net/tymo/dymo/DymoMonitor.nc"
static void DymoEngineM__DymoMonitor__msgSent(message_t *msg);

static void DymoEngineM__DymoMonitor__routeDiscovered(uint32_t delay, addr_t target);
#line 5
static void DymoEngineM__DymoMonitor__msgReceived(message_t *msg);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
storage_len_t len);
# 136 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static uint32_t DymoEngineM__Timer__getNow(void );
# 149 "/opt/tinyos-2.1.2/tos/lib/net/tymo/dymo/DymoEngineM.nc"
enum DymoEngineM____nesc_unnamed4370 {
#line 149
...
uint32_t DymoEngineM__rreq_time;
...
#line 457
static inline void DymoEngineM__Timer__fired(void );
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static 
#line 123
void * 
...
enum DymoPacketM____nesc_unnamed4374 {
#line 131
...
enum Stm25pConfigP____nesc_unnamed4375 {
...
#line 70
typedef struct Stm25pConfigP____nesc_unnamed4377 {
  uint16_t addr;
  void *buf;
  uint16_t len;
  uint8_t req;
...
enum Stm25pConfigP____nesc_unnamed4380 {
...
enum Stm25pSectorP____nesc_unnamed4381 {
#line 86
...
#line 60
typedef enum Stm25pSectorP____nesc_unnamed4383 {
...
# 49 "/opt/tinyos-2.1.2/tos/system/FcfsResourceQueueC.nc"
enum /*Stm25pSectorC.ArbiterC.Queue*/FcfsResourceQueueC__2____nesc_unnamed4385 {
#line 49
...
# 75 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
enum /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1____nesc_unnamed4386 {
#line 75
...
enum /*Stm25pSectorC.PowerManagerC.PowerManager*/DeferredPowerManagerP__0____nesc_unnamed4390 {
#line 79
...
enum Stm25pSpiP____nesc_unnamed4392 {
...
#line 60
typedef enum Stm25pSpiP____nesc_unnamed4393 {
...
enum Stm25pSpiP____nesc_unnamed4394 {
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x40803b28){
#line 39
  switch (arg_0x40803b28) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x40803b28);
#line 39
      break;
#line 39
    }
...
# 88 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x41083148, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x41083148, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40bf3460){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  switch (arg_0x40bf3460) {
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40bf3460);
#line 128
      break;
#line 128
    }
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40bf3460){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40bf3460);
#line 97
      break;
#line 97
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40d06010){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40d06010);
#line 61
}
#line 61
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40bf3460){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40bf3460);
#line 88
      break;
#line 88
    }
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x40d06010){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x40d06010);
#line 53
}
#line 53
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40bf3460){
#line 120
  unsigned char __nesc_result;
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40bf3460);
#line 120
      break;
#line 120
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40d05430){
#line 65
  switch (arg_0x40d05430) {
#line 65
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40d05430);
#line 65
      break;
#line 65
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40d07520){
#line 102
  Stm25pSectorP__Stm25pResource__granted(arg_0x40d07520);
#line 102
}
#line 102
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40d05430){
#line 59
    /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40d05430);
#line 59
}
#line 59
...
# 121 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static void Stm25pSectorP__Sector__eraseDone(uint8_t arg_0x41354ae0, uint8_t sector, uint8_t num_sectors, error_t error){
#line 121
  switch (arg_0x41354ae0) {
#line 121
...
#line 121
    default:
#line 121
      Stm25pSectorP__Sector__default__eraseDone(arg_0x41354ae0, sector, num_sectors, error);
#line 121
      break;
#line 121
    }
...
# 101 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static void Stm25pSectorP__Sector__writeDone(uint8_t arg_0x41354ae0, stm25p_addr_t addr, uint8_t *buf, stm25p_len_t len, error_t error){
#line 101
  switch (arg_0x41354ae0) {
#line 101
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__VOLUME_ID:
...
#line 101
    default:
#line 101
      Stm25pSectorP__Sector__default__writeDone(arg_0x41354ae0, addr, buf, len, error);
#line 101
      break;
#line 101
    }
...
# 91 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static error_t Stm25pConfigP__Sector__write(uint8_t arg_0x412ec430, stm25p_addr_t addr, uint8_t *buf, stm25p_len_t len){
#line 91
  unsigned char __nesc_result;
#line 91

#line 91
  switch (arg_0x412ec430) {
#line 91
...
#line 91
    default:
#line 91
      __nesc_result = Stm25pConfigP__Sector__default__write(arg_0x412ec430, addr, buf, len);
#line 91
      break;
#line 91
    }
...
# 144 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static void Stm25pSectorP__Sector__computeCrcDone(uint8_t arg_0x41354ae0, stm25p_addr_t addr, stm25p_len_t len, uint16_t crc, error_t error){
#line 144
  switch (arg_0x41354ae0) {
#line 144
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__VOLUME_ID:
...
#line 144
    default:
#line 144
      Stm25pSectorP__Sector__default__computeCrcDone(arg_0x41354ae0, addr, len, crc, error);
#line 144
      break;
#line 144
    }
...
# 78 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static void Stm25pSectorP__Sector__readDone(uint8_t arg_0x41354ae0, stm25p_addr_t addr, uint8_t *buf, stm25p_len_t len, error_t error){
#line 78
  switch (arg_0x41354ae0) {
#line 78
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__VOLUME_ID:
...
#line 78
    default:
#line 78
      Stm25pSectorP__Sector__default__readDone(arg_0x41354ae0, addr, buf, len, error);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void Stm25pSectorP__ClientResource__granted(uint8_t arg_0x41354068){
#line 102
  switch (arg_0x41354068) {
#line 102
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__VOLUME_ID:
#line 102
...
#line 102
    default:
#line 102
      Stm25pSectorP__ClientResource__default__granted(arg_0x41354068);
#line 102
      break;
#line 102
    }
...
# 68 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static error_t Stm25pConfigP__Sector__read(uint8_t arg_0x412ec430, stm25p_addr_t addr, uint8_t *buf, stm25p_len_t len){
#line 68
  unsigned char __nesc_result;
#line 68
...
#line 68
    default:
#line 68
      __nesc_result = Stm25pConfigP__Sector__default__read(arg_0x412ec430, addr, buf, len);
#line 68
      break;
#line 68
    }
...
# 48 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pVolume.nc"
inline static volume_id_t Stm25pSectorP__Volume__getVolumeId(uint8_t arg_0x41353a60){
#line 48
  unsigned char __nesc_result;
#line 48

#line 48
  switch (arg_0x41353a60) {
#line 48
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__VOLUME_ID:
#line 48
...
#line 48
    default:
#line 48
      __nesc_result = Stm25pSectorP__Volume__default__getVolumeId(arg_0x41353a60);
#line 48
      break;
#line 48
    }
...
# 133 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static error_t Stm25pConfigP__Sector__computeCrc(uint8_t arg_0x412ec430, uint16_t crc, stm25p_addr_t addr, stm25p_len_t len){
#line 133
  unsigned char __nesc_result;
#line 133
...
#line 133
    default:
#line 133
      __nesc_result = Stm25pConfigP__Sector__default__computeCrc(arg_0x412ec430, crc, addr, len);
#line 133
      break;
#line 133
    }
...
# 112 "/opt/tinyos-2.1.2/tos/chips/stm25p/Stm25pSector.nc"
inline static error_t Stm25pConfigP__Sector__erase(uint8_t arg_0x412ec430, uint8_t sector, uint8_t num_sectors){
#line 112
  unsigned char __nesc_result;
#line 112
...
#line 112
    default:
#line 112
      __nesc_result = Stm25pConfigP__Sector__default__erase(arg_0x412ec430, sector, num_sectors);
#line 112
      break;
#line 112
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40d05430){
#line 65
    /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40d05430);
#line 65
}
#line 65
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Stm25pSectorP__Stm25pResource__release(uint8_t arg_0x413511b8){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  __nesc_result = /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__Resource__release(arg_0x413511b8);
#line 120
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Stm25pConfigP__ClientResource__release(uint8_t arg_0x412f5380){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x412f5380) {
#line 120
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__CONFIG_ID:
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = Stm25pConfigP__ClientResource__default__release(arg_0x412f5380);
#line 120
      break;
#line 120
    }
...
# 36 "/opt/tinyos-2.1.2/tos/interfaces/Mount.nc"
inline static void Stm25pConfigP__Mount__mountDone(uint8_t arg_0x412f9928, error_t error){
#line 36
  switch (arg_0x412f9928) {
#line 36
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__CONFIG_ID:
#line 36
...
#line 36
    default:
#line 36
      Stm25pConfigP__Mount__default__mountDone(arg_0x412f9928, error);
#line 36
      break;
#line 36
    }
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40d06010){
#line 53
    /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40d06010);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Stm25pSectorP__Stm25pResource__request(uint8_t arg_0x413511b8){
#line 88
  unsigned char __nesc_result;
#line 88

#line 88
  __nesc_result = /*Stm25pSectorC.ArbiterC.Arbiter*/ArbiterP__1__Resource__request(arg_0x413511b8);
#line 88
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Stm25pConfigP__ClientResource__request(uint8_t arg_0x412f5380){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = Stm25pConfigP__ClientResource__default__request(arg_0x412f5380);
#line 88
      break;
#line 88
    }
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/ConfigStorage.nc"
inline static void Stm25pConfigP__Config__readDone(uint8_t arg_0x412f7170, storage_addr_t addr, void * buf, storage_len_t len, error_t error){
#line 80
  switch (arg_0x412f7170) {
#line 80
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__CONFIG_ID:
#line 80
...
#line 80
    default:
#line 80
      Stm25pConfigP__Config__default__readDone(arg_0x412f7170, addr, buf, len, error);
#line 80
      break;
#line 80
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/ConfigStorage.nc"
inline static void Stm25pConfigP__Config__writeDone(uint8_t arg_0x412f7170, storage_addr_t addr, void * buf, storage_len_t len, error_t error){
#line 110
  switch (arg_0x412f7170) {
#line 110
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__CONFIG_ID:
...
#line 110
    default:
#line 110
      Stm25pConfigP__Config__default__writeDone(arg_0x412f7170, addr, buf, len, error);
#line 110
      break;
#line 110
    }
...
# 133 "/opt/tinyos-2.1.2/tos/interfaces/ConfigStorage.nc"
inline static void Stm25pConfigP__Config__commitDone(uint8_t arg_0x412f7170, error_t error){
#line 133
  switch (arg_0x412f7170) {
#line 133
    case /*DymoServiceC.ConfigStorageC*/ConfigStorageC__0__CONFIG_ID:
...
#line 133
    default:
#line 133
      Stm25pConfigP__Config__default__commitDone(arg_0x412f7170, error);
#line 133
      break;
#line 133
    }
...
# 145 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline void TestM__DymoMonitor__routeDiscovered(uint32_t delay, addr_t target)
#line 145
{
  ;
...
# 9 "/opt/tinyos-2.1.2/tos/lib/net/tymo/dymo/DymoMonitor.nc"
inline static void DymoEngineM__DymoMonitor__routeDiscovered(uint32_t delay, addr_t target){
#line 9
  TestM__DymoMonitor__routeDiscovered(delay, target);
#line 9
}
#line 9
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
#line 320
            ...
            if (
#line 325
            DymoEngineM__rreq_time
             && DymoEngineM__cur_info_pos == 2
             && DymoEngineM__DymoPacket__getType(msg) == DYMO_RREP) {
                DymoEngineM__rreq_time = DymoEngineM__Timer__getNow() - DymoEngineM__rreq_time;
                DymoEngineM__DymoMonitor__routeDiscovered(DymoEngineM__rreq_time, info->address);
                DymoEngineM__rreq_time = 0;
              }
...
# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*DymoTableC.DymoTableM*/DymoTableM__0__Timer__stop(uint8_t arg_0x4116ce38){
#line 78
  /*DymoTableC.Timers*/VirtualizeTimerC__1__Timer__stop(arg_0x4116ce38);
#line 78
}
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x41084a98, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x41084a98, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x41083148, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x41083148, msg);
#line 95
}
#line 95
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*DymoTableC.DymoTableM*/DymoTableM__0__Timer__startOneShot(uint8_t arg_0x4116ce38, uint32_t dt){
#line 73
  /*DymoTableC.Timers*/VirtualizeTimerC__1__Timer__startOneShot(arg_0x4116ce38, dt);
#line 73
}
#line 73
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*DymoTableC.Timers*/VirtualizeTimerC__1__Timer__fired(uint8_t arg_0x40f7c9f0){
#line 83
  /*DymoTableC.DymoTableM*/DymoTableM__0__Timer__fired(arg_0x40f7c9f0);
#line 83
}
#line 83
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x410fc258, message_t * msg, error_t error){
#line 100
  switch (arg_0x410fc258) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x410fc258, msg, error);
#line 100
      break;
#line 100
    }
...
# 141 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline void TestM__DymoMonitor__msgSent(message_t *msg)
#line 141
{
  ;
...
# 7 "/opt/tinyos-2.1.2/tos/lib/net/tymo/dymo/DymoMonitor.nc"
inline static void DymoEngineM__DymoMonitor__msgSent(message_t *msg){
#line 7
  TestM__DymoMonitor__msgSent(msg);
#line 7
}
#line 7
...
#line 85
# 241 "/opt/tinyos-2.1.2/tos/lib/net/tymo/ForwardingEngineM.nc"
static inline void /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__sendFailed(message_t *msg, uint8_t why)
#line 241
{
}
...
#line 5
  /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__sendFailed(msg, why);
#line 5
}
#line 5
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x410fcc40, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x410fcc40, addr, msg, len);
#line 80
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x4102a628){
#line 102
  switch (arg_0x4102a628) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x4102a628);
#line 102
      break;
#line 102
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__AMSend__sendDone(uint8_t arg_0x411e72f0, message_t * msg, error_t error){
#line 110
  switch (arg_0x411e72f0) {
#line 110
    case 1:
#line 110
...
#line 110
    default:
#line 110
      /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__AMSend__default__sendDone(arg_0x411e72f0, msg, error);
#line 110
      break;
#line 110
    }
...
#line 126
# 111 "/opt/tinyos-2.1.2/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline int8_t CC2420PacketP__CC2420Packet__getRssi(message_t *p_msg)
#line 111
{
...
# 64 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static int8_t TestM__CC2420Packet__getRssi(message_t *p_msg){
#line 64
...
#line 64
# 34 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline uint16_t TestM__getRssi(message_t *msg)
#line 34
{
  return (uint16_t )TestM__CC2420Packet__getRssi(msg);
}
...
#line 127
{
  TestM__rssi = TestM__getRssi(msg);
  TestM__setLeds(2);
  return TRUE;
}
...
# 31 "/opt/tinyos-2.1.2/tos/interfaces/Intercept.nc"
inline static bool /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__Intercept__forward(uint8_t arg_0x411e63a0, message_t * msg, void * payload, uint8_t len){
#line 31
  unsigned char __nesc_result;
#line 31

#line 31
  switch (arg_0x411e63a0) {
#line 31
    case 1:
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__Intercept__default__forward(arg_0x411e63a0, msg, payload, len);
#line 31
      break;
#line 31
    }
...
# 457 "/opt/tinyos-2.1.2/tos/lib/net/tymo/dymo/DymoEngineM.nc"
static inline void DymoEngineM__Timer__fired(void )
#line 457
{
}
...
#line 126
# 73 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline void TestM__Timer__fired(void )
#line 73
{
  nx_uint16_t *payload = TestM__Packet__getPayload(&TestM__packet, 2);
  error_t error;

#line 76
  __nesc_hton_uint16((*payload).nxdata, 1664);
  if (TestM__flag) {
      TestM__dest = TestM__NODE_X;
      TestM__flag = 0;
    }
  else {
      TestM__dest = TestM__TARGET;
      TestM__flag = 1;
    }

  error = TestM__MHSend__send(TestM__dest, &TestM__packet, sizeof  (*payload));
  if (error == SUCCESS) {
      ;
    }
  else 
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40f7c9f0){
#line 83
  switch (arg_0x40f7c9f0) {
#line 83
    case 1U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40f7c9f0);
#line 83
      break;
#line 83
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x41086088, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x41086088, msg, payload, len);
#line 78
...
#line 78
# 78 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t TestM__MHPacket__destination(message_t * amsg){
#line 78
  unsigned int __nesc_result;
#line 78
...
#line 68
# 107 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline message_t *TestM__Receive__receive(message_t *msg, void *payload, uint8_t len)
#line 107
{
...
#line 113
    if (TestM__MHPacket__destination(msg) == TestM__NODE_X) {
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__Receive__receive(uint8_t arg_0x411e7cb0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x411e7cb0) {
#line 78
    case 1:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__Receive__default__receive(arg_0x411e7cb0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 239 "/opt/tinyos-2.1.2/tos/lib/net/tymo/ForwardingEngineM.nc"
static inline void /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__msgReceived(message_t *msg)
#line 239
{
}
...
#line 3
  /*MHServiceC.ForwardingEngineM*/ForwardingEngineM__0__MHControl__default__msgReceived(msg);
#line 3
}
#line 3
...
#line 74
# 137 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline void TestM__DymoMonitor__msgReceived(message_t *msg)
#line 137
{
  ;
...
# 5 "/opt/tinyos-2.1.2/tos/lib/net/tymo/dymo/DymoMonitor.nc"
inline static void DymoEngineM__DymoMonitor__msgReceived(message_t *msg){
#line 5
  TestM__DymoMonitor__msgReceived(msg);
#line 5
}
#line 5
...
#line 203
{
  ...
  DymoEngineM__DymoMonitor__msgReceived(msg);
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x410879d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x410879d0) {
#line 78
    case 8:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x410879d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40bf5030){
#line 102
  switch (arg_0x40bf5030) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__1__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40bf5030);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40d07520){
#line 102
  switch (arg_0x40d07520) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40d07520);
#line 102
      break;
#line 102
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40bf3eb0){
#line 39
  union __nesc_unnamed4285 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40bf3eb0);
#line 39
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40d05430){
#line 59
  switch (arg_0x40d05430) {
#line 59
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40d05430);
#line 59
      break;
#line 59
    }
...
# 82 "/opt/tinyos-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40bf4be0, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x40bf4be0) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__1__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40bf4be0, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40b4f010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40b4f010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40b4f010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x41083148, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x41083148, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40b4f010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40b4f010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40b4f010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40b50558){
#line 102
  switch (arg_0x40b50558) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x40b50558);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x41087010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x41087010, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 41
# 133 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline void TestM__SplitControl__stopDone(error_t e)
#line 133
{
}
...
#line 64
# 67 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline void TestM__SplitControl__startDone(error_t e)
#line 67
{
...
#line 105
# 96 "/opt/tinyos-2.1.2/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline error_t CC2420CsmaP__SplitControl__stop(void )
#line 96
{
  if (CC2420CsmaP__SplitControlState__isState(CC2420CsmaP__S_STARTED)) {
...
inline static uint8_t Stm25pConfigP__Sector__getNumSectors(uint8_t arg_0x412ec430){
#line 56
  unsigned char __nesc_result;
#line 56
...
#line 56
    default:
#line 56
      __nesc_result = Stm25pConfigP__Sector__default__getNumSectors(arg_0x412ec430);
#line 56
      break;
#line 56
    }
...
#line 104
# 62 "/home/brad/workspace/TestTymo/src/TestM.nc"
static inline void TestM__Boot__booted(void )
#line 62
{
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40cd50c0, uint8_t data){
#line 54
  switch (arg_0x40cd50c0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40cd50c0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x40cd5940){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x40cd5940);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40cd50c0){
#line 49
  switch (arg_0x40cd50c0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40cd50c0);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x40803b28){
#line 39
  switch (arg_0x40803b28) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x40803b28);
#line 39
      break;
#line 39
    }
...
#line 389
        {
          if (!DymoEngineM__busyIssue) {
              ...
              DymoEngineM__rreq_time = DymoEngineM__Timer__getNow();
...
#line 445
  ...
  if (error == SUCCESS) {
    DymoEngineM__DymoMonitor__msgSent(msg);
    }
}
...
# 94 "/home/brad/workspace/TestTymo/src/TestM.nc"
static void TestM__MHSend__sendDone(message_t *msg, error_t e)
#line 94
{
  if (e == SUCCESS && msg == &TestM__packet && TestM__MHPacket__address() == TestM__ORIGIN) {
      ;
      TestM__setLeds(1);
    }
  else {
